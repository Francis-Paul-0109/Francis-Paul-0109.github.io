...
footer: false
masthead: false
background-color: #C7B199  # 포스트별 배경색 변경 가능
---
...
<section class="auto-scrolly">
  ...
  <div class="scrolly-text">
    ...
    <div class="step" data-img="3. css coding.jpg">
      ...
      컴퓨터 파일의 변경사항을 추적하고 여러 명의 사용자들 간에 해당 파일들의 작업을 조율하기 위한 분산 버전 관리 시스템을 활용합니다.
      ...
      개발이나 코딩을 잘 아는가라고 묻는다면 절대 단호하게 아니라고 대답하는 사람이기에 처음엔 조금 겁이 났습니다.
